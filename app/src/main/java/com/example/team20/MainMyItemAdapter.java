...
public class MainMyItemAdapter extends RecyclerView.Adapter<MainMyItemAdapter.CustomViewHolder> {

    private ArrayList<MainData> arrayList;
    private Intent intent;
    private Bitmap bitmap;
    public MainMyItemAdapter(ArrayList<MainData> arrayList) {
        this.arrayList = arrayList;
    }

    @NonNull
    @Override
    public MainMyItemAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MainMyItemAdapter.CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(view.getContext(), ChangeActivity.class);
