...
//        join_pwck = findViewById(R.id.join_pwck);
        ...
        binding.btnIdCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String UserEmail = binding.etxtJoinEmail.getText().toString();
                if (validate) {
                    return; //검증 완료
                }
                if (UserEmail.equals("")) {
...
//                                check_button.setBackgroundColor(getResources().getColor(R.color.colorGray));
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(JoinRequestActivity.this);
...
//                RequestQueue queue = Volley.newRequestQueue(JoinRequestActivity.this);
...
//                                dialog.show();
                ...
                //서버로 Volley를 이용해서 요청
//                JoinRequestActivity joinRequestActivity = new JoinRequestActivity( UserId, UserEmail, UserPwd);
//                RequestQueue queue = Volley.newRequestQueue( JoinRequestActivity.this );
//                queue.add(joinRequestActivity);
            }
        });
    }
}