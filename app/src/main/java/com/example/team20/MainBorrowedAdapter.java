...
public class MainBorrowedAdapter extends RecyclerView.Adapter<MainBorrowedAdapter.CustomViewHolder> {

    private ArrayList<MainData> arrayList;
    private Intent intent;
    private Bitmap bitmap;
    public MainBorrowedAdapter(ArrayList<MainData> arrayList) {
        this.arrayList = arrayList;
    }

    @NonNull
    @Override
    public MainBorrowedAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MainBorrowedAdapter.CustomViewHolder holder, int position) {
