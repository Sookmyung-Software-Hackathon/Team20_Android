...
public class RentAdapter extends RecyclerView.Adapter<RentAdapter.CustomViewHolder> {
    ...
    public RentAdapter(ArrayList<ReturnData> arrayList) {
        this.arrayList = arrayList;
    }

    @NonNull
    @Override
    public RentAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RentAdapter.CustomViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(view.getContext(), RentItemActivity.class);
